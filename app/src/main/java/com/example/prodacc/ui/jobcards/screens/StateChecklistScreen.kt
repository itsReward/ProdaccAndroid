...
fun StateChecklistSectionContent(
    ...
    val checklistItems = mutableMapOf<String, MutableState<String>>().apply {
        ...
        put(
            "fuelLevelIn",
            mutableStateOf(existingChecklist?.checklist?.get("fuelLevelIn") ?: "------")
        )
        put(
            "fuelLevelOut",
            mutableStateOf(existingChecklist?.checklist?.get("fuelLevelOut") ?: "------")
        )

        // Tools
        put(
            "wheelSpanner",
            mutableStateOf(existingChecklist?.checklist?.get("wheelSpanner") ?: options[0])
        )
        ...
        put(
            "firstAidKit",
            mutableStateOf(existingChecklist?.checklist?.get("firstAidKit") ?: options[0])
        )
        put("spanners", mutableStateOf(existingChecklist?.checklist?.get("spanners") ?: options[0]))
        put(
            "fireExtinguisher",
            mutableStateOf(existingChecklist?.checklist?.get("fireExtinguisher") ?: options[0])
        )

        // Wheels and Tires
        put(
            "wheelStuds",
            mutableStateOf(existingChecklist?.checklist?.get("wheelStuds") ?: options[0])
        )
        put(
            "spareWheel",
            mutableStateOf(existingChecklist?.checklist?.get("spareWheel") ?: options[0])
        )
        put("size", mutableStateOf(existingChecklist?.checklist?.get("size") ?: ""))
        put(
            "rightFrontWheel",
            mutableStateOf(existingChecklist?.checklist?.get("rightFrontWheel") ?: options[0])
        )
        put(
            "leftFrontWheel",
            mutableStateOf(existingChecklist?.checklist?.get("leftFrontWheel") ?: options[0])
        )
        put(
            "rightRearWheel",
            mutableStateOf(existingChecklist?.checklist?.get("rightRearWheel") ?: options[0])
        )
        put(
            "leftRearWheel",
            mutableStateOf(existingChecklist?.checklist?.get("leftRearWheel") ?: options[0])
        )
        ...
        put(
            "radioTape",
            mutableStateOf(existingChecklist?.checklist?.get("radioTape") ?: options[0])
        )
        ...
        put(
            "cdShuttle",
            mutableStateOf(existingChecklist?.checklist?.get("cdShuttle") ?: options[0])
        )
        put(
            "modulator",
            mutableStateOf(existingChecklist?.checklist?.get("modulator") ?: options[0])
        )
        ...
        put(
            "rightFrontLight",
            mutableStateOf(existingChecklist?.checklist?.get("rightFrontLight") ?: options[0])
        )
        put(
            "leftFrontLight",
            mutableStateOf(existingChecklist?.checklist?.get("leftFrontLight") ?: options[0])
        )
        put(
            "interiorLight",
            mutableStateOf(existingChecklist?.checklist?.get("interiorLight") ?: options[0])
        )
        put("fogLight", mutableStateOf(existingChecklist?.checklist?.get("fogLight") ?: options[0]))
        put(
            "rightRearLight",
            mutableStateOf(existingChecklist?.checklist?.get("rightRearLight") ?: options[0])
        )
        put(
            "leftRearLight",
            mutableStateOf(existingChecklist?.checklist?.get("leftRearLight") ?: options[0])
        )
        put(
            "bootLight",
            mutableStateOf(existingChecklist?.checklist?.get("bootLight") ?: options[0])
        )
        put(
            "bonnetLight",
            mutableStateOf(existingChecklist?.checklist?.get("bonnetLight") ?: options[0])
        )

        // Additional
        put(
            "bootHandle",
            mutableStateOf(existingChecklist?.checklist?.get("bootHandle") ?: options[0])
        )
        ...
        put(
            "engineCovers",
            mutableStateOf(existingChecklist?.checklist?.get("engineCovers") ?: options[0])
        )
        ...
        put(
            "rearWindScreen",
            mutableStateOf(existingChecklist?.checklist?.get("rearWindScreen") ?: options[0])
        )
        put("boot", mutableStateOf(existingChecklist?.checklist?.get("boot") ?: options[0]))
        put(
            "engineCover",
            mutableStateOf(existingChecklist?.checklist?.get("engineCover") ?: options[0])
        )
        put(
            "bonnetLiner",
            mutableStateOf(existingChecklist?.checklist?.get("bonnetLiner") ?: options[0])
        )
        put(
            "rightFrontDoorTrim",
            mutableStateOf(existingChecklist?.checklist?.get("rightFrontDoorTrim") ?: options[0])
        )
        put(
            "leftFrontDoorTrim",
            mutableStateOf(existingChecklist?.checklist?.get("leftFrontDoorTrim") ?: options[0])
        )
        put(
            "rightRearDoorTrim",
            mutableStateOf(existingChecklist?.checklist?.get("rightRearDoorTrim") ?: options[0])
        )
        put(
            "leftRearDoorTrim",
            mutableStateOf(existingChecklist?.checklist?.get("leftRearDoorTrim") ?: options[0])
        )
        put(
            "rightFrontSunVisor",
            mutableStateOf(existingChecklist?.checklist?.get("rightFrontSunVisor") ?: options[0])
        )
        put(
            "leftFrontSunVisor",
            mutableStateOf(existingChecklist?.checklist?.get("leftFrontSunVisor") ?: options[0])
        )
        put("overMats", mutableStateOf(existingChecklist?.checklist?.get("overMats") ?: options[0]))
        put(
            "gloveCompartment",
            mutableStateOf(existingChecklist?.checklist?.get("gloveCompartment") ?: options[0])
        )
        ...
        put(
            "windscreen",
            mutableStateOf(existingChecklist?.checklist?.get("windscreen") ?: options[0])
        )
        put(
            "rearScreen",
            mutableStateOf(existingChecklist?.checklist?.get("rearScreen") ?: options[0])
        )
        put(
            "rightFrontGlass",
            mutableStateOf(existingChecklist?.checklist?.get("rightFrontGlass") ?: options[0])
        )
        put(
            "leftFrontGlass",
            mutableStateOf(existingChecklist?.checklist?.get("leftFrontGlass") ?: options[0])
        )
        put(
            "rightRearGlass",
            mutableStateOf(existingChecklist?.checklist?.get("rightRearGlass") ?: options[0])
        )
        put(
            "leftRearGlass",
            mutableStateOf(existingChecklist?.checklist?.get("leftRearGlass") ?: options[0])
        )
        put(
            "interiorMirror",
            mutableStateOf(existingChecklist?.checklist?.get("interiorMirror") ?: options[0])
        )
        put(
            "rightDoorMirror",
            mutableStateOf(existingChecklist?.checklist?.get("rightDoorMirror") ?: options[0])
        )
        put(
            "leftDoorMirror",
            mutableStateOf(existingChecklist?.checklist?.get("leftDoorMirror") ?: options[0])
        )
        ...
        put(
            "centralLocking",
            mutableStateOf(existingChecklist?.checklist?.get("centralLocking") ?: options[0])
        )
        put(
            "dashBoard",
            mutableStateOf(existingChecklist?.checklist?.get("dashBoard") ?: options[0])
        )
        put(
            "instrumentCluster",
            mutableStateOf(existingChecklist?.checklist?.get("instrumentCluster") ?: options[0])
        )
        put(
            "windowWinders",
            mutableStateOf(existingChecklist?.checklist?.get("windowWinders") ?: options[0])
        )
        put(
            "cigaretteLighters",
            mutableStateOf(existingChecklist?.checklist?.get("cigaretteLighters") ?: options[0])
        )
        put("mats", mutableStateOf(existingChecklist?.checklist?.get("mats") ?: options[0]))
        put(
            "ownersManual",
            mutableStateOf(existingChecklist?.checklist?.get("ownersManual") ?: options[0])
        )
        ...
        put(
            "bonnetStar",
            mutableStateOf(existingChecklist?.checklist?.get("bonnetStar") ?: options[0])
        )
        put(
            "grillStar",
            mutableStateOf(existingChecklist?.checklist?.get("grillStar") ?: options[0])
        )
    }
