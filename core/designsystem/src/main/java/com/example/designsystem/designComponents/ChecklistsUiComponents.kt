...
fun StateChecklist(
    ...
    Column(
        ...
        ElevatedCard(onClick = { }, modifier = Modifier.padding(vertical = 5.dp, horizontal = 10.dp)) {
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .wrapContentHeight(),
                ...
                MediumTitleText("$jobCardName State Checklist")
...
// Roller Blinds Section
            ...
            Row(
                ...
                Button(
                    ...
                    androidx.wear.compose.material.Text("Save")
                }
            }
